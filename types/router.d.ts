...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/components/favoriteMovieList` | `/components/movieDetails` | `/components/movieList` | `/favorites` | `/redux/slices/movieSlice` | `/redux/store` | `/types/movie` | `/types/rootState` | `/utils/api`;
